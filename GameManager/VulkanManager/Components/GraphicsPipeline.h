...
/* Vulkan Tutorial - Alexander Overvoorde - October 2019 - page 93 - 96
    ...
    to turn vertex positions from model space to screen space. It also passes pervertex
    ...
    discard it or output more primitives than came in. This is similar to the tessellation
    shader, but much more flexible. However, it is not used much in today’s
    ...
    shaders, bind different framebuffers or change the blend function. The disadvantage
    is that you’ll have to create a number of pipelines that represent all of the
